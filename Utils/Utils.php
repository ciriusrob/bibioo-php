...
class Utils
{
    ...
    public static function fromBase64( $base64String, $outputFile)
    {
    ...
    public static function getRandomWord($len = 3)
    {
    ...
    {
        return substr(time(), 2, 10) . Utils::getRandomWord();
    }


    /***************************************************
     * Inflector Methods BEGINS.
     ***************************************************/
    /***************************************************
     * 
    ...
    static function pluralize($word)
    {
        ...
        $plural_rules = array(
            ...
            '/(p)erson$/i' => '\1eople', # store, salesperson
    ...
    static function camelize($lower_case_and_underscored_word)
    {
        ...
        return str_replace(" ", "", ucwords(preg_replace("/[-_]/", " ", $lower_case_and_underscored_word)));
    }
